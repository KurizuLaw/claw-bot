...
class owner(commands.Cog, name="owner"):
    ...
    async def say(self, context, *, args):
        """
        Der bot sagt, was auch immer du willst.
        """
        if context.message.author.id in config.OWNERS:
    ...
    async def embed(self, context, *, args):
        """
        Der bot sagt, was auch immer du willst, aber eingebettet.
        """
        if context.message.author.id in config.OWNERS:
            embed = discord.Embed(
                description=args,
    ...
    async def blacklist(self, context):
        """
        Lässt dich einen nutzer auf der Bot Blacklist hinzufügen oder entfernen.
        """
